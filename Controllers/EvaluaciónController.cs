...
namespace MvcProject.Controllers
{
    public class EvaluaciónController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nota,AlumnoId,AsignaturaId,Id,Nombre")] Evaluación evaluación)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Nota,AlumnoId,AsignaturaId,Id,Nombre")] Evaluación evaluación)
        {
            if (id != evaluación.Id)
            {
                return NotFound();
